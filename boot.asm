...
bits 32 ; the CS is 32-bit formatted, so this is necessary!
...
jmp 0x08:.here
.here
jmp 0x08:kernel_area 	; jump to the pasted kernel (the floppy track 0 is loaded in memory)
				;	7c00h			entry (sector 0)
				;	+200h			this loader (sector 1..i)
				;	+((n-1)*200h)	beginning of kernel (sector n)
				;	+x				=> the extracted entry method (best at 0x0)
